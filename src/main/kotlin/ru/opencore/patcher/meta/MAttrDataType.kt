...
var formatAttrDataTypeSqlPostgres = "INSERT INTO s_mt.t_d_attr_data_type(ck_id, cv_description, cl_extra, ck_user, ct_change)" +
		"VALUES(%s, %s, %s, %s, %s) " +
		"on conflict (ck_id) do update set cv_description = excluded.cv_description, cl_extra = excluded.cl_extra, ck_user = excluded.ck_user, ct_change = excluded.ct_change;"
