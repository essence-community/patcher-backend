...
var formatMClassAttrSqlPostgres = "INSERT INTO s_mt.t_class_attr" +
		...
		" on conflict on constraint cin_c_class_attr_1 do update set ck_id = excluded.ck_id, ck_class = excluded.ck_class, ck_attr = excluded.ck_attr, cv_value = excluded.cv_value, ck_user = excluded.ck_user, ct_change = excluded.ct_change, cl_required = excluded.cl_required, cl_empty = excluded.cl_empty;"
